        ...
        <div class="container">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <p class="text-white link-nav"><a href="<?php echo base_url(); ?>usuario"><?php
  
  echo "Perfil de ".$this->session->userdata('login');
  ?> </a>  <span class="lnr lnr-arrow-right"></span>  <a href="<?php echo base_url(); ?>daradopcion"> Poner en Adopción</a></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="Volunteer-form-area section-gap">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <?php echo form_open_multipart('daradopcion/agregarbd');?>
                        <div class="form-row">
                            <label name="IdCuenta"><?php echo $this->session->userdata('idusuario');?></label>
                        </div>
                        <div class="form-group">
                            <label for="first-name">Nombre</label>
                            <input type="text" name="Nombre" class="form-control" placeholder="Nombre de tu mascota" required>
                        </div>
                        <div class="form-row">
                            <div class="col-6 mb-30">
                                <label for="last-name">Edad</label>
                                <input type="text" name="Edad" class="form-control" placeholder="Edad de tu mascota" >
                            </div>
                            <div class="col-6 mb-30">
                                <label for="Raza">Raza</label>
                                <input type="text" name="Raza" class="form-control" placeholder="Raza de tu mascota" >
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-6 mb-30">
                                ...
                                <input type="text" name="Color" class="form-control" placeholder="Color de tu mascota" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="Description" id="exampleTextarea" rows="5" placeholder="Describe un poco del caracter de tu mascota"></textarea>
                        </div>
                        
                        <!--<button type="file" name="foto" accept="jpg">subir imagen</button>-->
                        <div class="form-group">
                            <input type="file" data-classbutton="btn btn-default" data-classinput="form-control inline" class="filestyle form-control" id="filestyle-0" tabindex="-1" style="position: absolute; left: -9999px;">
                            <div class="bootstrap-filestyle" style="display: inline;" tabindex="0">

                                <input type="text" name="Imagen" class="form-control inline" disabled="">
                                <br>
                                <label for="filestyle-0" class="btn btn-outline-warning btn-default">
                                    <i class="icon-folder-open"></i>
                                    <span>Selecciona una imagen</span>
                                </label>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-outline-warning btn-default">Registrar Mascota</button>
                    <?php echo form_close();?>   
                </div>
