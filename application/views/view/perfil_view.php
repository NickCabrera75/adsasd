                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-9">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            <div class="col-6 mb-30">
                                                <label for="size">Tamaño de tu hogar</label>
                                                <div class="select-option" id="tamano-select">
                                                    <select name="tamano">
                                                        <option data-display="Seleccione el tamaño de su hogar">Seleccione el tamaño de su hogar</option>
                                            ...
                                            <div class="col-6 mb-30">
                                                ...
                                                <input type="text" name="telefono" class="form-control" placeholder="Numeros de telefono adicional">
                                            </div>
                                        </div>
...
<br>
    ...
    {
        //echo $_GET['id'];
        if($row->IdMascotas == $_GET['id'])
            {?>
            <h2 class="modal-title text-center" font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Perfil de <?php echo $row->Nombre; ?></font></h2>
